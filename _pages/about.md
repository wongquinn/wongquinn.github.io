...
``[comment]: # - Ding C, **Wang K***, Zhang G. Physics-Informed Terminal Optimal Guidance against a Stationary Target[J], **Under review.**
...
``[comment]: # - **Wang K**. Look-Angle-Shaped Impact Time Control Guidance with Field-of-View Constraints. [J], **Under review.**
